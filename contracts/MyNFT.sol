...
contract MyNFT is ERC721 {
     ...
     * @return A boolean indicating if the user has a valid balance.
     */
    ...
    function checkBalance(address account) public view returns (bool) {
        (bool success, bytes memory data) = otherContract.call(abi.encodeWithSignature("balanceOf(address)", account));
